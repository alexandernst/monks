...
int ProcmonUI::change_loaded_state(int state){
    QDBusMessage msg;
    if(state == -1){
...
int ProcmonUI::change_running_state(int state){
...
void ProcmonUI::change_btns_state(int states[]){
...
void ProcmonUI::add_syscall_data(const QString &data){
